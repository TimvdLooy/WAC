...
function zoekFunctie(){
	$(".lul").remove();
	$.getJSON("http://localhost:4711/firstapp/restservices/Countries/zoek/" + $("#zoekWaarde").val() + "", function(data){
		var index = 0;
		$.each(data, function(key, value){
			console.log(value);
			var naam = "\'"+ value["name"] + "\'";
...
$("#insert").click(function(){
			var uri = "http://localhost:4711/firstapp/restservices/Countries";
	    $.ajax(uri, { 
	        type: "post", 
...
$(document).ready ( function () {
	$(document).on('click', "#put", function(){
		var uri = "http://localhost:4711/firstapp/restservices/Countries/" + isoCode;
	    $.ajax(uri, { 
	        type: "put", 
	...
	$(document).on('click', "#DELETE", function(){
		var uri = "http://localhost:4711/firstapp/restservices/Countries/delete/" + isoCode;
	    $.ajax(uri, { 
	        type: "DELETE", 
	        data: $("#updateForm").serialize(), 
	        beforeSend: function(xhr){
